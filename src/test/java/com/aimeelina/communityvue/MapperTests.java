...
public class MapperTests {
    ...
    */
    ...
    public void insertExerciseTest2(){
        ...
        exercise.setSubChapterId(1);
        exercise.setQuestionId(1);
        exercise.setQuestion("单选A");
        exercise.setOptions("不是这项@是这项@看别的@错的选项");
        exercise.setAnswers(UtilFuncs.stringAnswerToIntAnswer("A"));
        exercise.setType(0);
        exercise.setCourseId(1);
        exerciseMapper.insertExercise(exercise);
        exercise=new Exercise();
        ...
        exercise.setSubChapterId(1);
        exercise.setQuestionId(2);
        exercise.setQuestion("单选B");
        exercise.setOptions("不是这项@是这项@看别的@错的选项");
        exercise.setAnswers(UtilFuncs.stringAnswerToIntAnswer("B"));
        exercise.setType(0);
        exercise.setCourseId(1);
        exerciseMapper.insertExercise(exercise);
        exercise=new Exercise();
        exercise.setChapterId(1);
        exercise.setSubChapterId(1);
        exercise.setQuestionId(3);
        exercise.setQuestion("双选CD");
        exercise.setOptions("不是这项@是这项@看别的@错的选项");
        exercise.setAnswers(UtilFuncs.stringAnswerToIntAnswer("CD"));
        exercise.setType(1);
        exercise.setCourseId(1);
        exerciseMapper.insertExercise(exercise);
        exercise=new Exercise();
        exercise.setChapterId(1);
        exercise.setSubChapterId(1);
        exercise.setQuestionId(4);
        exercise.setQuestion("判断T");
        exercise.setOptions("");
        exercise.setAnswers(UtilFuncs.stringAnswerToIntAnswer("T"));
        exercise.setType(2);
        exercise.setCourseId(1);
        exerciseMapper.insertExercise(exercise);
